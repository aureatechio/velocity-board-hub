      ...
      <div className="flex-1">
        ...
        >
          {stages.map((stage, i) => (
            ...
            >
              <div className={cn("rounded-xl p-4", stage.color)}>
                <span className="text-3xl font-bold font-display text-foreground">{stage.value}</span>
              </div>
              <p className="text-xs text-muted-foreground mt-2 uppercase">{stage.label}</p>
        ...
        >
          <div className="flex items-center gap-2 mb-3">
            ...
            <span className="text-sm text-muted-foreground uppercase">Risco Alto (parados +5 dias)</span>
          </div>
        ...
        <motion.div
          ...
          animate={{ opacity: 1 }}
          transition={{ delay: 1 }}
          className="mt-4 p-4 bg-warning/10 rounded-xl border border-warning/30"
        >
          ...
          <p className="text-foreground">
            <span className="text-2xl font-bold">8</span> negócios com prazo/urgência
          </p>
        </motion.div>
      </div>
    </div>
